...
exports.isZ = function (coin) {
	const algo = (coin !== null && coin.algorithm !== undefined) ? coin.algorithm : coin;
	if (algo === 'equihash' || algo === 'verus') return true;
	else return false;
};

exports.byteUnits = function (coin) {
	const algo = (coin !== null && coin.algorithm !== undefined) ? coin.algorithm : coin;
	if (algo === 'equihash' || algo === 'verus') return [ ' Sol/s', ' KSol/s', ' MSol/s', ' GSol/s', ' TSol/s', ' PSol/s' ];
	else return [ ' KH/s', ' MH/s', ' GH/s', ' TH/s', ' PH/s' ];
};
